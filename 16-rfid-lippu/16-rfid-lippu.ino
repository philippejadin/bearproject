...
const char MODULE_NAME[] = "16-rfid-lippu"; // à changer pour chaque module, pour l'identifier facilement, à mettre en début de sketch
...
void setup() {
  bear_init();
  Wire.begin(11);                // join i2c bus with address #10

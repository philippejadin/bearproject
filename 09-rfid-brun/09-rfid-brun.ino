...
void loop() {
  ...
  if (bear_has_card()) {
    ...
    if (food == 0) {
      ...
      Serial.println("09-result-brun1.h264");
    }

    else if (food == 2) {
      Serial.println("09-result-brun2.h264");
    }

    else if (food == 3) {
      Serial.println("09-result-brun3.h264");
    }

    else if (food == 4) {
      Serial.println("09-result-brun4.h264");
    }

    else if (food == 5) {
      Serial.println("09-result-brun5.h264");
    }

    else if (food == 6) {
      Serial.println("09-result-brun6.h264");
    }

    else if (food == 7) {
      Serial.println("09-result-brun7.h264");
    }

    else if (food == 8) {
      Serial.println("09-result-brun8.h264");
    }
    else if (food == 9) {
      Serial.println("09-result-brun9.h264");
    }
    else if (food == 10) {
      Serial.println("09-result-brun10.h264");
    }
    else if (food == 11) {
      Serial.println("09-result-brun11.h264");
    }
    bear_led_blink();
